...
filename = "./snapshots/Re_" + str(int(re))+"/w/w_0.npy"
np.save(filename, w)
#np.savetxt(filename, w, delimiter=",")
filename = "./snapshots/Re_" + str(int(re))+"/s/s_0.npy"
np.save(filename, s)
...
for k in range(1,nt+1):
    ...
    if (k%freq == 0):
        filename = "./snapshots/Re_" + str(int(re))+"/w/w_"+str(int(k/freq))+".npy"
        np.save(filename, w)
#        np.savetxt(filename, w, delimiter=",")
        filename = "./snapshots/Re_" + str(int(re))+"/s/s_"+str(int(k/freq))+".npy"
        np.save(filename, s)
#        np.savetxt(filename, s, delimiter=",")
